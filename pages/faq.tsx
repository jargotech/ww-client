                ...
                <div className="faq-wrapper">
                    <MediaQuery minWidth={1100}>
                        ...
                        <Grid container spacing={2}>
                            <Grid item lg={6}>
                                <Tabs component="ul" className="faq-list" value={value} onChange={handleChange} aria-label="basic tabs example">
                                    {
                                        faqList
                                        &&
                                ...
                                <div className="tab-content">
                                    {
                                        ...
                                        faqList.map((faq, index) => (
                                            ...
                                            No, you do not need to pay Instapay where there is no transaction happening. With one of the lowest transaction charges in the industry, pay only when you get paid!
                                                ...
                                                <p dangerouslySetInnerHTML={createMarkup(faq.answer)}></p>
                                            </TabPanel>
                                        ))
                                    }
                        ...
                        <div className="faq-accordion-wrapper">
                            {
                                ...
                                &&
                                faqList.map((faq, index) => (
                                    <Accordion key={index} expanded={expanded === `panel${index}`} onChange={accordionHandleChange('panel1')}>
